...
class ImagesDataset(Dataset):
    ...
    def __init__(self, source_root, target_root, opts, target_transform=None, source_transform=None, test=None):
        ...
        if test:
            if 'car' in source_root:
                test_size = self.source_paths.__len__() //4
            else:
                test_size = self.source_paths.__len__() //2

            self.source_paths = self.source_paths[:test_size]
            self.target_paths = self.target_paths[:test_size]
